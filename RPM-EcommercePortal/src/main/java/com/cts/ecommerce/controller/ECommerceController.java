...
public class ECommerceController {
	...
	@Autowired
	RestTemplate restTemplate;// it cunsumes all the restful web services

	JwtResponse jwtResponse;
	@Autowired
	ECommerceService eCommerceService;
//handles critical failures in the application
	private static final Logger log = LoggerFactory.getLogger(ECommerceController.class);// to log a message

	@GetMapping("/")
	public String initial(Model model) {  //model is the container contains the data of application
