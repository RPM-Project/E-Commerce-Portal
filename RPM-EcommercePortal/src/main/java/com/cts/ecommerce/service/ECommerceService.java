...
public class ECommerceService {
	...
	@Autowired
	RestTemplate restTemplate; //--------it is consumes restful web services all http methods
	@Value("${api-server.uri}")   //it is in application properties == to inject with the value
	private String uri;
	HttpHeaders headers = new HttpHeaders(); //the value of names that are displayed int the req and 
													//responce of header message

	HttpEntity<String> entity = new HttpEntity<>(headers); //consists of header and body
